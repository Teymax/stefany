...
// window.i18n = localStorage.getItem( 'i18n' ) || location.pathname.match(
// /(ru|ua)/g )[ 0 ] window.i18n = localStorage.getItem( 'i18n' ) || ''
// window.town = localStorage.getItem( 'town' ) || '' window.towns = { zt  : {
// ua: { rest   : { kiev: 'Київ', if  : 'Івано-Франківськ' }, current:
// 'Житомир' }, ru: { rest   : { kiev: 'Киев', if  : 'Ивано-Франковск' },
// current: 'Житомир' } }, kiev: { ua: { rest   : { zt: 'Житомир', if:
// 'Івано-Франківськ' }, current: 'Київ' }, ru: { rest   : { zt: 'Житомир', if:
...
$( document ).ready( function () {
  ...
  // $( '.selectpicker' )
  //   .on( 'changed.bs.select', function ( e, clickedIndex, isSelected,
  // previousValue ) { // console.log( arguments ) // console.log(
  // e.target.children[clickedIndex].value ) localStorage.setItem( 'town',
